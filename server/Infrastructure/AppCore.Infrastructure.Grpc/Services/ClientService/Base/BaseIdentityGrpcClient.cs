...
{
    public class BaseIdentityGrpcClient
    {
        public readonly BaseGrpcClient _baseGrpcClient;
        public const ServiceNameEnum serviceNameEnum = ServiceNameEnum.IdentityService;
        public BaseIdentityGrpcClient(BaseGrpcClient baseGrpcClient)
        {
